...
public class GridSetup extends JDialog {
	...
	public static SetupButton buttons[][] = new SetupButton[10][10]; /// Create
	/// button
	/// objects
	/// for
	/// grid

	private static String shipName = "Aircraft Carrier"; // default value for
															// ship
	private static String shipOrient = "Horizontal"; // default value for
														// orientation
	// #array
	public static int[][] shipArray = { { -1, -1, 0 }, { -1, -1, 0 }, { -1, -1, 0 }, { -1, -1, 0 }, { -1, -1, 0 } }; // initialize
																														// array
																														// for
																														// ships
	public static int[][] aiArray = { { -1, -1, 0 }, { -1, -1, 0 }, { -1, -1, 0 }, { -1, -1, 0 }, { -1, -1, 0 } }; // initialize
																													// array
																													// for
																													// ai
	private static int shipNum = -1; // initialize ship id
	...
	private void initialize() {
		...
		final JComboBox shipNames = new JComboBox();
	...
	private static boolean check(byte shipLen, String shipOrient, int yCoord, int xCoord, int shipArray[][],
			int shipNum) {
		// checks for validity of ship placement
